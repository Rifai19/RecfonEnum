...
import com.ayyash.recfonenum.MainAdapter;
...
public class SelinganMalamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.selingan_malam_activity);
        ...
        GetData(ConfigUmum.URL_SHOW_SELINGAN_MALAM + responden);
