...
public class SearchableListDialogAktifitas extends DialogFragment implements
    ...
    public SearchableListDialogAktifitas() {

    }

    public static SearchableListDialogAktifitas newInstance(List items) {
        SearchableListDialogAktifitas multiSelectExpandableFragment = new
                SearchableListDialogAktifitas();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String strTitle = _strTitle == null ? "Pilih Aktifitas Yang Anda Kerjakan" : _strTitle;
