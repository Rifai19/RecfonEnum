...
public class SearchableSpinnerAktifitas extends Spinner implements View.OnTouchListener,
    ...
    public SearchableSpinnerAktifitas(Context context) {
        super(context);
        this._context = context;
        init();
    }

    public SearchableSpinnerAktifitas(Context context, AttributeSet attrs) {
        super(context, attrs);
        this._context = context;
    ...
    public SearchableSpinnerAktifitas(Context context, AttributeSet attrs, int defStyleAttr) {
