...
public class SearchableSpinnerMS extends Spinner implements View.OnTouchListener,
    ...
    public SearchableSpinnerMS(Context context) {
        super(context);
        this._context = context;
        init();
    }

    public SearchableSpinnerMS(Context context, AttributeSet attrs) {
        super(context, attrs);
        this._context = context;
    ...
    public SearchableSpinnerMS(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void onSearchableItemClicked(Object item, int position) {
       ...
       // Toast.makeText(getContext(),"Anda Menambahkan "+selectedItem,Toast.LENGTH_LONG).show();
        ...
        Intent i = new Intent(_context, PerhitunganMakanSiang.class);
