package com.ayyash.recfonenum.selinganpagi;
...
public class SearchableSpinnerSP extends Spinner implements View.OnTouchListener,
    ...
    public SearchableSpinnerSP(Context context) {
        super(context);
        this._context = context;
        init();
    }

    public SearchableSpinnerSP(Context context, AttributeSet attrs) {
        super(context, attrs);
        this._context = context;
    ...
    public SearchableSpinnerSP(Context context, AttributeSet attrs, int defStyleAttr) {
